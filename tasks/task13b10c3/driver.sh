#!/usr/bin/env bash
# Frozen scored order: A-F, G, H, I, then unseen J; five repetitions each.
set -uo pipefail
E=/home/jarvis/.hermes-poc/evidence/task13b10c3-provenance-lock
