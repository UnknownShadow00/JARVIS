"""Execute the frozen C2 collector with only C3 evidence/lane field wiring changed.
...
replacements = {
    'assert SUITE in ("orig", "g", "h", "i") and 1 <= REP <= 5 and ATTEMPT >= 1':
        'assert SUITE in ("orig", "g", "h", "i", "j") and 1 <= REP <= 5 and ATTEMPT >= 1',
    'EVIDENCE = Path("/home/jarvis/.hermes-poc/evidence/task13b10c2-response-selector")':
        'EVIDENCE = Path("/home/jarvis/.hermes-poc/evidence/task13b10c3-provenance-lock")',
    'HOME = Path("/home/jarvis/.hermes-poc/task13b10c2-home-granite")':
        'HOME = Path("/home/jarvis/.hermes-poc/task13b10c3-home-granite")',
    'PHASE_FILE = Path("/tmp/task13b10c2-current-phase")':
        'PHASE_FILE = Path("/tmp/task13b10c3-current-phase")',
    '"i": "i_sessions"}[SUITE]':
        '"i": "i_sessions", "j": "j_sessions"}[SUITE]',
    '"i": (7, 10)}[SUITE]':
        '"i": (7, 10), "j": (10, 10)}[SUITE]',
    '"task": "13B10C2"':
        '"task": "13B10C3"',
