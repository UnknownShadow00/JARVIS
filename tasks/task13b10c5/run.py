"""Execute the frozen C2 collector with only C5 evidence/lane/suite wiring changed."""
...
replacements = {
    'assert SUITE in ("orig", "g", "h", "i") and 1 <= REP <= 5 and ATTEMPT >= 1':
        'assert SUITE in ("orig", "g", "h", "i", "j", "k", "l") and 1 <= REP <= 5 and ATTEMPT >= 1',
    'EVIDENCE = Path("/home/jarvis/.hermes-poc/evidence/task13b10c2-response-selector")':
        'EVIDENCE = Path("/home/jarvis/.hermes-poc/evidence/task13b10c5-operational-utility")',
    'HOME = Path("/home/jarvis/.hermes-poc/task13b10c2-home-granite")':
        'HOME = Path("/home/jarvis/.hermes-poc/task13b10c5-home-granite")',
    'PHASE_FILE = Path("/tmp/task13b10c2-current-phase")':
        'PHASE_FILE = Path("/tmp/task13b10c5-current-phase")',
    '"i": "i_sessions"}[SUITE]':
        '"i": "i_sessions", "j": "j_sessions", "k": "k_sessions", "l": "l_sessions"}[SUITE]',
    '"i": (7, 10)}[SUITE]':
        '"i": (7, 10), "j": (10, 10), "k": (12, 12), "l": (8, 12)}[SUITE]',
    '"task": "13B10C2"':
        '"task": "13B10C5"',
    '"response_need_class": g["response_need_class"],':
        '"response_need_class": g["response_need_class"], "response_lane": g["response_lane"], "response_obligation": g["response_obligation"], "c4_lock_shadow": g["c4_lock_shadow"],',
